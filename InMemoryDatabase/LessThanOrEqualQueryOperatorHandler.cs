...
{
    [QueryItemHandler(QueryOperator.LessThanOrEqual)]
    internal class LessThanOrEqualQueryOperatorHandler : AbstractQueryItemHandler
    {
        ...
        {
            {
                return token =>
                {
                    ...
                    return currentObj != null &&
                           (currentObj.Type == JTokenType.Integer || currentObj.Type == JTokenType.Float) &&
